...
//  Project14-Penguin
//
//  Created by Mahmud CIKRIK on 21.10.2023.
//
...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        // bundan sonra tekrar tekrar kendisini çağıracak bu sayede
    ...
    func createEnemy() {
        ...
        // bu kod bu fonksiyonun kendi kendine çalışmasını sağlıyormuş?
